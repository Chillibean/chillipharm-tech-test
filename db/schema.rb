...
ActiveRecord::Schema.define(version: 2020_03_13_143250) do
  ...
  create_table "asset_infos", force: :cascade do |t|
    ...
    t.datetime "deleted_at"
    t.index ["asset_id", "info_field_id"], name: "asset_id_info_field_id", unique: true
    t.index ["deleted_at"], name: "index_asset_infos_on_deleted_at"
  end
  ...
  create_table "info_fields", force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_info_fields_on_deleted_at"
  end
